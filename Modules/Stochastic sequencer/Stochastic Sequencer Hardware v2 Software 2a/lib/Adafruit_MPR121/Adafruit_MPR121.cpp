 ...
 */
boolean Adafruit_MPR121::begin(uint8_t i2caddr, i2c_t3 *theWire,
...
uint8_t Adafruit_MPR121::readRegister8(uint8_t reg) {
  ...
  _wire->write(reg);
  _wire->endTransmission(I2C_NOSTOP,100);
...
void Adafruit_MPR121::writeRegister(uint8_t reg, uint8_t value) {
  ...
  //ECR register is what determines whether the MPR121 is in sleep mode or not
  //Serial.print("ECR value ");
  //Serial.println(ECR);
